const TariffHit = ({
  ...
  return (
    <div className="bg-[#313637] p-[0_20px_0_50px] w-[100%] h-[190px] border-2 border-[#484D4E] rounded-[40px] flex justify-between max-[375px]:h-[131px] max-[320px]:h-[118px] max-[375px]:p-[0_11px_0_30px]  max-[320px]:p-[0_11px_0_11px] max-[375px]:rounded-[20px] max-[320px]:rounded-[20px]">
