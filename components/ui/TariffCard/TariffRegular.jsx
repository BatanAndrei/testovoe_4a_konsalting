  ...
  return (
    ...
    >
      ...
      <div className="mt-[24px] w-[100%] h-[126px] max-[375px]:w-[121px] max-[320px]:w-[107px]">
        ...
        <div
          className={`${discountHasDisappeared && 'opacity-0 translate-y-[-20px]'} transition-all duration-3000 ease-in-out mt-[5px] pr-[40px] flex justify-end w-[100%][8px_10px_0_0] line-through text-[#919191] text-[24px] font-montserrat font-regular max-[375px]:text-[16px] max-[320px]:text-[14px] max-[375px]:pr-[0px] max-[320px]:pr-[0px] max-[375px]:m-[8px_15px_0_0] max-[320px]:m-[8px_15px_0_0] max-[375px]:w-[101px] max-[320px]:w-[90px]`}
        >
          {originalPrice}
        </div>
      </div>
      <div
        className={`mt-[70px] p-[0_20px_0_20px] flex items-start w-[100%] h-[90px] text-[16px] text-[#FFFFFF] ont-montserrat font-regular whitespace-pre-line max-[375px]:flex max-[320px]:flex max-[375px]:flex-col max-[320px]:flex-col max-[375px]:items-start max-[320px]:items-start max-[375px]:leading-none max-[320px]:leading-none max-[375px]:text-[14px] max-[320px]:text-[14px] max-[375px]:pl-[40px] max-[320px]:pl-[40px] max-[375px]:h-[114px] max-[320px]:h-[114px] ${discountHasDisappeared ? 'max-[375px]:mt-[50px] max-[320px]:mt-[50px]' : 'max-[375px]:mt-[0px] max-[320px]:mt-[0px]'}`}
      >
        {!discountHasDisappeared && (
