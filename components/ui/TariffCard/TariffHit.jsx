  ...
  return (
    ...
    >
      ...
      <div className="mt-[24px] w-[178px] h-[126px] max-[375px]:w-[121px] max-[320px]:w-[107px] max-[375px]:h-[91px] max-[320px]:h-[78px] max-[375px]:mt-[20px] max-[320px]:mt-[20px]">
        ...
        <div
          className={`flex justify-center w-[178px] h-[50px] text-[#FDB056] text-[50px] font-montserrat font-semibold max-[375px]:text-[34px] max-[320px]:text-[30px] max-[375px]:justify-start max-[320px]:justify-start max-[375px]:w-[121px] max-[320px]:w-[110px] max-[375px]:h-[34px] max-[320px]:h-[30px]`}
        >
